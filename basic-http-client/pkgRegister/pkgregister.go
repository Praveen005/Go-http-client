...
func registerPackageData(url string, data pkgData) (pkgRegisterResult, error){
	...
	//we will create an io.Reader object for this byte slice using the NewReader() function from the bytes package.
	...
	//If you have a large payload, creating a bytes.Reader from the byte slice (as you did in your example) allows you to avoid loading the entire payload into memory at once.
